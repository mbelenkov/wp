...
class ACS_Color_Schemes {
	...
	private $colors = array(
		...
		'cruise', 'flat', 'lawn', 'seashore', 'wamp'
	);
	...
	function add_colors() {
		...
		wp_admin_css_color(
			'wamp', __( 'Wamp', 'admin_schemes' ),
			plugins_url( "wamp/colors$suffix.css", __FILE__ ),
			array( '#3C3C3C', '#F5F5F5', '#FF5A5F', '#087E8B' ),
			array( 'base' => '#3C3C3C', 'focus' => '#FF5A5F', 'current' => '#F5F5F5' )
		);
